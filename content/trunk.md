...
> **PREVIOUS VERSION.** The opening passages of the branching lost-property
> story, already loaded into the database and kept as a fallback at `/n/[id]`.
> Not part of the climbing tree. The current copy file is `content/tree-copy.md`.
